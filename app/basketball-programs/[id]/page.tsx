...
import { getBBCoach } from "@/lib/data/coaches";
...
export default async function CoachPage({
  ...
  const data = await getBBCoach({ coachid });
  ...
  return (
    <>
      <Breadcrumbs pageName={coach.m_coach ?? ""} />
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-6 text-sm sm:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <div className="font-medium text-[#FF7200]">{coach.m_coach ?? ""}</div>
              ...
              <div className="space-y-2">
                ...
                <div className="break-all">{coach.m_email}</div>
              </div>

              <div className="space-y-2">
                <div className="text-xs uppercase text-gray-500">Phone</div>
                <div>{coach.m_phone}</div>
              </div>
            </div>
