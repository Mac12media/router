...
import { users, endpoints, logs, leads, postSubmittedProfiles } from "./schema";
...
export type PostSubmittedProfile = InferSelectModel<typeof postSubmittedProfiles>;
export type NewPostSubmittedProfile = InferInsertModel<typeof postSubmittedProfiles>;
